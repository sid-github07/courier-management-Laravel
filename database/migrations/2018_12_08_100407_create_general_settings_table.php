...
class CreateGeneralSettingsTable extends Migration {
    ...
    public function up() {
        Schema::create('general_settings', function (Blueprint $table) {
            ...
            $table->string('search_currier_title')->nullable();
            $table->text('search_currier_details')->nullable();
            ...
            $table->integer('departure_currier')->nullable();
            $table->integer('upcoming_currier')->nullable();
