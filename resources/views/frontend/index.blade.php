            ...
            <div class="row SelectArea">
                <div class="col-md-6 col-lg-6 offset-1 offset-md-1">
                    <div class="input-group">
                        ...
                        <input type="text" name="currier_invoice" class="form-control form-control-lg invoice-search" aria-describedby="basic-addon1" value="{{request()->currier_invoice}}" placeholder="Enter Currier Code/Invoice">
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="c-box">
                    ...
                    <h3>Departure Currier</h3>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="c-box">
                    <p class="count">{{ $gs->upcoming_currier }}</p><span>+</span>
                    <h3>Upcoming Currier</h3>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="c-box">
